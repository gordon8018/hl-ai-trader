...
class FeatureSnapshot1m(BaseModel):
    ...
    top_depth_usd_l10: Dict[str, float] = Field(default_factory=dict)
    ...
    # order flow (1m)
    trade_volume_1m: Dict[str, float] = Field(default_factory=dict)
    trade_volume_buy_ratio: Dict[str, float] = Field(default_factory=dict)
    trade_count_1m: Dict[str, float] = Field(default_factory=dict)
    aggr_buy_volume_1m: Dict[str, float] = Field(default_factory=dict)
    aggr_sell_volume_1m: Dict[str, float] = Field(default_factory=dict)
    aggr_delta_1m: Dict[str, float] = Field(default_factory=dict)
    aggr_delta_5m: Dict[str, float] = Field(default_factory=dict)
    volume_imbalance_1m: Dict[str, float] = Field(default_factory=dict)
    volume_imbalance_5m: Dict[str, float] = Field(default_factory=dict)
    buy_pressure_1m: Dict[str, float] = Field(default_factory=dict)
    sell_pressure_1m: Dict[str, float] = Field(default_factory=dict)
    absorption_ratio_bid: Dict[str, float] = Field(default_factory=dict)
    absorption_ratio_ask: Dict[str, float] = Field(default_factory=dict)
    # microstructure dynamics
    microprice_change_1m: Dict[str, float] = Field(default_factory=dict)
    book_imbalance_change_1m: Dict[str, float] = Field(default_factory=dict)
    spread_change_1m: Dict[str, float] = Field(default_factory=dict)
    depth_change_1m: Dict[str, float] = Field(default_factory=dict)
...
class FeatureSnapshot15m(BaseModel):
    ...
    # order flow + microstructure change (from 1m)
    trade_volume_1m: Dict[str, float] = Field(default_factory=dict)
    trade_volume_buy_ratio: Dict[str, float] = Field(default_factory=dict)
    trade_count_1m: Dict[str, float] = Field(default_factory=dict)
    aggr_buy_volume_1m: Dict[str, float] = Field(default_factory=dict)
    ...
    ask_slope: Dict[str, float] = Field(default_factory=dict)
    queue_imbalance_l1: Dict[str, float] = Field(default_factory=dict)
    # cross-market (BTC/ETH baseline)
    btc_ret_1m: Dict[str, float] = Field(default_factory=dict)
    btc_ret_15m: Dict[str, float] = Field(default_factory=dict)
    btc_vol_15m: Dict[str, float] = Field(default_factory=dict)
    eth_ret_1m: Dict[str, float] = Field(default_factory=dict)
    eth_ret_15m: Dict[str, float] = Field(default_factory=dict)
    market_ret_mean_1m: Dict[str, float] = Field(default_factory=dict)
    market_ret_std_1m: Dict[str, float] = Field(default_factory=dict)
    corr_btc_1h: Dict[str, float] = Field(default_factory=dict)
    corr_eth_1h: Dict[str, float] = Field(default_factory=dict)
    # regime
